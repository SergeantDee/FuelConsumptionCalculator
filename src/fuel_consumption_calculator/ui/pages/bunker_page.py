...
class BunkerPage(QWidget):
    ...
    def __init__(
        ...
        sounding_title = QLabel("Actual Sounding ROB")
        sounding_title.setObjectName("sectionTitle")
        sounding_layout.addWidget(sounding_title)
        ...
        capacity_title = QLabel("Vessel Capacity Settings")
        capacity_title.setObjectName("sectionTitle")
        capacity_grid.addWidget(capacity_title, 0, 0, 1, 3)
        ...
        projection_title = QLabel("Port Projection")
        projection_title.setObjectName("sectionTitle")
        layout.addWidget(projection_title)
