...
class MainWindow(QMainWindow):
    ...
    def _build_clock_row(self) -> QFrame:
        ...
        for button in (self.vessel_time_minus_button, self.vessel_time_plus_button):
            button.setObjectName("clockAdjustButton")
